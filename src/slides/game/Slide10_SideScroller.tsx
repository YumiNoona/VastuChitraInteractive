...
export default function Slide10_SideScroller() {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--t-label)', fontWeight: 600, letterSpacing: '0.11em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: 20 }}>
      ...
      <div style={{ display: 'flex', gap: 24 }}>
        ...
        >
          ...
          <div style={{ aspectRatio: '16/9', borderRadius: 8, background: 'linear-gradient(180deg, #1A1A2E 0%, #0D0D1A 100%)', marginBottom: 14, overflow: 'hidden', transform: isVisible ? 'scale(1)' : 'scale(1.06)', transition: 'transform 800ms ease' }} />
          <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--t-h2)', fontWeight: 500, color: 'var(--text)' }}>Hollow Knight</h3>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--t-small)', color: 'var(--text-muted)', lineHeight: 1.7, marginTop: 8 }}>
        ...
        >
          ...
          <div style={{ aspectRatio: '16/9', borderRadius: 8, background: 'linear-gradient(180deg, #2E1A0A 0%, #1A0F05 100%)', marginBottom: 14, overflow: 'hidden', transform: isVisible ? 'scale(1)' : 'scale(1.06)', transition: 'transform 800ms ease' }} />
